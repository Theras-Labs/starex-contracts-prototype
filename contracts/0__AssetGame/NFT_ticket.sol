...
// import "https://github.com/BuildOnViction/vrc725/blob/main/contracts/VRC725.sol";
import "../_viction/VRC725/VRC725.sol";

/// @title A contract for entering exclusive zone
/// @author 0xdellwatson
contract TICKET is VRC725 {
  ...
  constructor(
    address initialOwner // ERC721("TICKET", "TICKET") // Ownable(initialOwner)
  ) {
    __VRC725_init("Ticket", "TIX", msg.sender);
  }

  function _baseURI() internal pure override returns (string memory) {
    return "https://metadata-TICKET/";
  }
